...
export const TRANSFER_PLANNER_GENERATED_GRC_ASSOCIATE_TRACKS: TransferPlannerTrack[] = [
  {
    ...
    "summary": "The Green River Associate in Science Transfer Track 2 base used for engineering, computer science, physics, and related math-heavy transfer paths.",
    "bestFor": [
      "engineering",
      "computer science",
      "physics"
    ...
    "catalogYears": [
      {
        ...
        "terms": [
          ...
          },
          {
            "label": "Year 1 Winter",
            "courses": [
              "ENGL 126 or 127 or 128 (ELECTIVE)",
              "MATH& 152",
              "SOCIAL SCIENCE"
            ]
          },
        ...
        "slotExpansions": [
          {
            ...
            "note": "Stay on the chemistry branch with CHEM& 262, start the BioE biology branch with BIOL& 211, or use ENGR 250 when the destination major needs scientific computing."
          },
          {
            ...
            "note": "ChemE usually wants CHEM& 263 and often MATH 240, while BioE usually wants BIOL& 212 in this space."
          },
          {
            "termLabel": "Year 3 Fall",
            ...
            "note": "BioE usually uses this slot for BIOL& 213, while ChemE often uses it for ENGR 250 if scientific computing is still missing."
          }
        ],
        "notes": [
        ...
        "slotExpansions": [
          {
            ...
            "note": "The same chemistry, biology, and scientific-computing choices still fit best in the first open slot for 2025-2026."
          },
          {
            "termLabel": "Year 3 Fall",
            "slotLabel": "SELECT COURSE FROM LIST (slot 1)",
            ...
            "note": "The same chemistry-versus-biology-versus-linear-algebra choice still matches the strongest current ChemE and BioE branches in 2025-2026."
          },
          {
            "termLabel": "Year 3 Fall",
            "slotLabel": "SELECT COURSE FROM LIST (slot 2)",
            ...
            "note": "The final open slot still works best as either the end of the BioE biology sequence or the ChemE/BioE scientific-computing add-on."
          }
        ],
        "notes": [
...
export const TRANSFER_PLANNER_GENERATED_GRC_ASSOCIATE_TRACK_SUMMARY: { generatedAt: string; currentCatalogId: number; currentCatalogName: string; programMapPageCount: number; officialAssociateTrackCount: number; previousManualTrackCount: number; newlyAddedOfficialAssociateTrackCount: number; retainedLegacyTrackCount: number; generatedTrackCount: number; } = {
  ...
  "previousManualTrackCount": 4,
  "newlyAddedOfficialAssociateTrackCount": 82,
  "retainedLegacyTrackCount": 1,
  "generatedTrackCount": 86
};
