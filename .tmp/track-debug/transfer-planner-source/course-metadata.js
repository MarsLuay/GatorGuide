...
exports.TRANSFER_PLANNER_NORMALIZED_COURSE_METADATA = void 0;
const course_metadata_generated_1 = require("./course-metadata.generated");
const GRC_CURRENT_SOURCE_LINKS = [
    {
...
const UW_SEATTLE_COMPUTING_SOURCE_LINKS = [
    {
...
function grcCourseMetadata(code, title, creditValue, config = {}) {
    return {
        schoolId: "grc",
...
function uwCourseMetadata(schoolId, code, title, creditValue, config = {}) {
    return {
        schoolId,
        code: normalizeCourseCode(code),
        title,
...
const TRANSFER_PLANNER_MANUAL_COURSE_METADATA = [
...
exports.TRANSFER_PLANNER_NORMALIZED_COURSE_METADATA = [
    ...course_metadata_generated_1.TRANSFER_PLANNER_GENERATED_COURSE_METADATA,
