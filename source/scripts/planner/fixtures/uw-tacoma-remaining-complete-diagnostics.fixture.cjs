...
const tacomaRemainingPrograms = [
  ...
  },
  {
    ...
    family: "global-international-studies",
    officialSources: ["https://www.tacoma.uw.edu/sias/socs/global-studies-concentration"],
    expectedPathwayIds: [],
    publicAdmissionsLabels: ["Global Studies"],
    requiredCourseCodes: unique(courses(`
      TARTS 282, TARTS 406, TARTS 480, TCOM 230, TCOM 461, TECON 210, TECON 320, TECON 325,
      TECON 350, TECON 360, TECON 441, TEGL 201, TEGL 340, TFILM 377, TFILM 386, TFILM 387,
      TFILM 388, TGEOG 349, TGEOG 352, TGEOG 435, TGH 301, THIST 111, THIST 112, THIST 150,
      THIST 151, THIST 203, THIST 260, THIST 270, THIST 271, THIST 280, THIST 350, THIST 365,
      THIST 375, THIST 376, THIST 457, THIST 464, THIST 465, THIST 466, THIST 475, THIST 479,
      THIST 484, THIST 486, THIST 487, THIST 488, TLAW 215, TLAW 422, TLAW 424, TLAX 267,
      TLAX 277, TLAX 355, TLAX 376, TLAX 400, TLAX 410, TLAX 441, TLAX 461, TLAX 462, TLAX 465,
      TLAX 476, TLIT 251, TLIT 252, TLIT 253, TLIT 332, TLIT 351, TLIT 352, TPHIL 355,
      TPHIL 358, TPHIL 359, TPHIL 360, TPHIL 451, TPHIL 466, TPOLS 123, TPOLS 203, TPOLS 310,
      TPOLS 319, TPOLS 329, TPOLS 340, TPOLS 341, TPOLS 350, TPOLS 360, TPOLS 410, TPOLS 451,
      TRELIG 210, TRELIG 321, TRELIG 333, TRELIG 345, TRELIG 365, TRELIG 366, TRELIG 467,
      TSPAN 103, TSPAN 199, TSPAN 203, TSPAN 210, TSPAN 299, TSPAN 301, TSPAN 302, TSPAN 303,
      TSPAN 351, TSPAN 393, TURB 340, TURB 430, TWOMN 420, TWOMN 434
    `)),
    optionGroups: [
      { id: "global-studies-core", label: "Global interactions core", options: singleOptions(courses("TGH 301, THIST 150, THIST 151")) },
    ],
    courseBuckets: [
      { id: "global-studies-core", label: "Core courses", minCredits: 15, courseCodes: courses("TGH 301, THIST 150, THIST 151") },
      { id: "global-studies-international-focus", label: "International Focus", minCredits: 40, courseCodes: courses("TARTS 282, TARTS 406, TARTS 480, TCOM 230, TCOM 461, TECON 210, TECON 320, TECON 325, TECON 350, TECON 360, TECON 441, TEGL 201, TEGL 340, TFILM 377, TFILM 386, TFILM 387, TFILM 388, TGEOG 349, TGEOG 352, TGEOG 435, THIST 111, THIST 112, THIST 203, THIST 260, THIST 270, THIST 271, THIST 280, THIST 350, THIST 365, THIST 375, THIST 376, THIST 457, THIST 464, THIST 465, THIST 466, THIST 475, THIST 479, THIST 484, THIST 486, THIST 487, THIST 488, TLAW 215, TLAW 422, TLAW 424, TLAX 267, TLAX 277, TLAX 355, TLAX 376, TLAX 400, TLAX 410, TLAX 441, TLAX 461, TLAX 462, TLAX 465, TLAX 476, TLIT 251, TLIT 252, TLIT 253, TLIT 332, TLIT 351, TLIT 352, TPHIL 355, TPHIL 358, TPHIL 359, TPHIL 360, TPHIL 451, TPHIL 466, TPOLS 123, TPOLS 203, TPOLS 310, TPOLS 319, TPOLS 329, TPOLS 340, TPOLS 341, TPOLS 350, TPOLS 360, TPOLS 410, TPOLS 451, TRELIG 210, TRELIG 321, TRELIG 333, TRELIG 345, TRELIG 365, TRELIG 366, TRELIG 467, TSPAN 103, TSPAN 199, TSPAN 203, TSPAN 210, TSPAN 299, TSPAN 301, TSPAN 302, TSPAN 303, TSPAN 351, TSPAN 393, TURB 340, TURB 430, TWOMN 420, TWOMN 434") },
    ],
    genEdRequirements: ["Global Studies Concentration", "Bachelor of Arts", "Core courses", "International Focus", "Foreign Language", "Natural World"],
    requirementLabels: ["Global Studies Concentration", "Core courses", "International Focus", "Foreign Language", "Natural World"],
  },
  {
    campusId: "uw-tacoma",
  ...
  },
  {
    ...
    requiredCourseCodes: unique(courses(`
      ENGL 131, TGIS 311, TGIS 312, TGIS 313, TGIS 414, TGIS 415, TUDE 340, TURB 101,
      TURB 103, TURB 110, TURB 200, TURB 210, TURB 220, TURB 225, TURB 235, TURB 250, TURB 312, TURB 316,
      TURB 345, TURB 379, TURB 403, TURB 432, TURB 470, TURB 479, TURB 480, TURB 498
    `)),
    optionGroups: [
      { id: "urban-studies-options", label: "Community Engagement option or GIS Certificate option", options: [] },
      { id: "urban-studies-community-engagement-option", label: "Community Engagement option", options: [courses("TURB 235, TURB 220, TUDE 340")] },
      { id: "urban-studies-community-engagement-electives", label: "Choose two Community Engagement electives", options: singleOptions(courses("TURB 379, TURB 470, TURB 479, TURB 498")) },
      { id: "urban-studies-gis-option", label: "GIS Certificate option", options: singleOptions(courses("TGIS 311, TGIS 312, TGIS 313, TGIS 414, TGIS 415")) },
    ],
    courseBuckets: [
      { id: "urban-studies-shared", label: "Shared Curriculum Courses", minCredits: 20, courseCodes: courses("TURB 101, TURB 103, TURB 110, TURB 200, TURB 403") },
      { id: "urban-studies-foundation", label: "Foundation Courses", minCredits: 25, courseCodes: courses("TURB 210, TURB 225, TURB 250, TGIS 311, TURB 312, TURB 316, TURB 345, TURB 432, TURB 480") },
      { id: "urban-studies-community-engagement-option", label: "Community Engagement option", minCredits: 25, courseCodes: courses("TURB 235, TURB 220, TUDE 340, TURB 379, TURB 470, TURB 479, TURB 498") },
      { id: "urban-studies-gis-certificate-option", label: "GIS Certificate option", minCredits: 25, courseCodes: courses("TGIS 311, TGIS 312, TGIS 313, TGIS 414, TGIS 415") },
    ],
    genEdRequirements: ["Bachelor of Arts", "Urban Studies", "Spring 2026+ requirements", "Community Engagement option", "GIS Certificate option", "General electives"],
    requirementLabels: ["BA in Urban Studies", "Shared Curriculum Courses", "Foundation Courses", "Community Engagement option", "GIS Certificate option"],
  },
  {
    campusId: "uw-tacoma",
