...
- American Ethnic Studies
  - UW course: AAS 206
  - Classification: source-backed-choice-set-no-public-grc-path
  - Suggested phase: before-application
  - Reason: The source-backed UW requirement row is an alternate or choice-based set, but the published Green River sources still do not prove a planner-ready path from that set.
- American Ethnic Studies
  - UW course: AAS 210
  - Classification: source-backed-no-public-grc-equivalent
  - Suggested phase: before-application
  - Reason: The source-backed UW requirement is real, but the current public Green River sources do not prove a planner-ready equivalent path.
- American Ethnic Studies
  - UW course: AAS 220
  - Classification: source-backed-choice-set-no-public-grc-path
  - Suggested phase: before-application
...
- Aquatic Conservation & Ecology
  - UW course: ENGL 131
  - Classification: auto-promoted-guide-direct-equivalent
  - Guide-backed Green River set: ENGL& 101
  - Suggested phase: before-application
  - Reason: Parsed from the current primary degree page with high source-parse confidence. The official UW Green River equivalency guide includes ENGL 131 under uw-grc-guide:0446:english:england-101-5-formerly-engl-110. The best guide-backed match is a clean direct-course equivalency to ENGL& 101.
...
- Architectural Design
  - UW course: MATH 112
  - Classification: auto-promoted-guide-direct-equivalent
  - Guide-backed Green River set: MATH& 148
  - Suggested phase: before-enrollment
  - Reason: Parsed from the current primary degree page with high source-parse confidence. The official UW Green River equivalency guide includes MATH 112 under uw-grc-guide:0790:mathematics:mathand-148-5-formerly-math-157. The best guide-backed match is a clean direct-course equivalency to MATH& 148.
...
- Architectural Studies
  - UW course: MATH 124
  - Classification: auto-promoted-guide-direct-equivalent
  - Guide-backed Green River set: MATH& 151
  - Suggested phase: before-application
  - Reason: Parsed from the current primary degree page with high source-parse confidence. The official UW Green River equivalency guide includes MATH 124 under uw-grc-guide:0792:mathematics:mathand-151-5-formerly-math-124. The best guide-backed match is a clean direct-course equivalency to MATH& 151.
- Art History
  - UW course: ART 101
  - Classification: source-backed-choice-set-no-public-grc-path
  - Suggested phase: before-application
...
- American & Ethnic Studies (BA)
  - UW course: BIS 293
  - Classification: source-backed-generic-topic-course
  - Suggested phase: before-enrollment
  - Reason: The source-backed UW requirement row resolves to a generic topics, seminar, or independent-study style title, so the planner keeps it classified but non-promoted.
- American & Ethnic Studies (BA)
  - UW course: BWRIT 133
  - Classification: source-backed-campus-specific-no-public-grc-equivalent
  - Suggested phase: before-enrollment
...
- Applied Computing (BA)
  ...
  - Reason: The source-backed UW requirement row is an alternate or choice-based set, but the published Green River sources still do not prove a planner-ready path from that set.
- Applied Computing (BA)
  - UW course: STMATH 125
  - Classification: source-backed-campus-specific-no-public-grc-equivalent
  - Suggested phase: before-enrollment
  - Reason: The source-backed UW course uses a campus-specific lower-division code, but the current public Green River sources do not prove a matching planner path.
- Applied Computing (BA)
  - UW course: T INFO 250
  - Classification: source-backed-choice-set-no-public-grc-path
  - Suggested phase: before-enrollment
  - Reason: The source-backed UW requirement row is an alternate or choice-based set, but the published Green River sources still do not prove a planner-ready path from that set.
- Biology (BS)
