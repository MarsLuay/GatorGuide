export type CollegeScorecardCip4Program = {
  code: string;
  title: string;
};

// Generated from official College Scorecard institution-level program data.
export const COLLEGE_SCORECARD_CIP4_PROGRAMS: CollegeScorecardCip4Program[] = [
  {
    "code": "0100",
