...
const businessPrograms = [
  ...
  },
  {
    ...
    expectedPathwayIds: [
      ...
      "eastside-leadership-center-supply-chain-management-option",
    ],
    pathwayGroups: [
      ...
      { id: "mis-concentration", label: "Management Information Systems (MIS) Concentration" },
      { id: "retail-management-concentration", label: "Retail Management Concentration" },
      { id: "tim-concentration", label: "Technology & Innovation Management (TIM) Concentration" },
      { id: "self-directed-concentration", label: "Self-Directed Concentration" },
      { id: "eastside-leadership-center", label: "Business Administration degree: Eastside Leadership Center" },
      {
        id: "eastside-leadership-center-supply-chain-management-option",
        label: "Business Administration degree: Supply Chain Management (ELC)",
        suggestedCourses: bothellElcCourses,
      },
    ],
    requiredCourseCodes: unique([
    ...
    optionGroups: [
      {
        ...
        label: "Required Business Core prerequisite alternatives",
        options: bothellBusinessPrerequisiteOptions,
      },
      {
        id: "bothell-supply-chain-internship-or-research",
        label: "B BUS/ELCBUS 497 Guided Internship or B BUS/ELCBUS 499 Undergraduate Research",
        options: [["BBUS 497"], ["ELCBUS 497"], ["BBUS 499"], ["ELCBUS 499"]],
      },
      {
        id: "bothell-supply-chain-distribution-or-resource-planning",
        label: "B BUS/ELCBUS 485 Distribution and Logistics Management or B BUS/ELCBUS 486 Supply Chain Management Resource Planning",
        options: [["BBUS 485"], ["ELCBUS 485"], ["BBUS 486"], ["ELCBUS 486"]],
      },
    ],
    courseBuckets: [
      {
        id: "bothell-business-core",
        label: "Required Business Core",
        minCredits: 69,
        maxCredits: 70,
      ...
      {
        id: "bothell-elc-core",
        label: "Core courses- 45 credits",
        minCredits: 45,
        courseCodes: bothellElcCourses,
      },
      {
        id: "bothell-business-capstone",
        label: "Capstone",
        minCredits: 10,
        courseCodes: ["BBUS 470", "BBUS 480", "ELCBUS 470"],
      },
      {
        id: "bothell-business-options",
        label: "Option and concentration requirements",
        minCredits: 20,
        maxCredits: 40,
        courseCodes: unique([
          ...bothellAccountingOptionCourses,
        ...
        openEndedRules: [
          ...
          "Completion of at least 60 credits in business, with a minimum of 45 credits at UW Bothell",
          "Marketing Electives (15 credits)",
          "Concentration: 20 credits",
          "The Self-Directed Concentration is NOT meant to allow students to pick and choose a handful of classes without developing a clear goal",
        ],
      },
    ],
    genEdRequirements: [
      ...
      "Minimum 1.7 grade in courses applied to the major",
    ],
    requirementLabels: [
      "Bachelor of Arts in Business Administration degree",
      "Bachelor of Arts in Business Administration degree: Eastside Leadership Center",
  ...
  },
  {
    ...
    title: "Business Administration",
    officialSources: [
      "https://www.washington.edu/students/gencat/program/T/BusinessAdministration-981.html",
      "https://www.tacoma.uw.edu/business/baba",
      "https://www.washington.edu/students/crscatt/tfin.html",
    ],
    expectedPathwayIds: [
      "accounting-option",
      "finance-option",
    ...
    pathwayGroups: [
      ...
      { id: "management-option", label: "Management" },
    ...
    optionGroups: [
      {
        id: "tacoma-business-economics",
        label: "T BECON 220 or TECON 200 and T BECON 221 or TECON 201",
        options: [["TBECON 220"], ["TECON 200"], ["TBECON 221"], ["TECON 201"]],
      },
      {
        id: "tacoma-business-information-core",
        label: "T BUS 330 or T ACCT 330 for accounting option",
        options: [["TBUS 330"], ["TACCT 330"]],
      },
    ],
    courseBuckets: [
      {
        id: "tacoma-business-core",
        label: "Business Core Course Requirements",
        minCredits: 35,
      ...
      },
      {
        ...
        minCredits: 30,
        maxCredits: 35,
        courseCodes: unique([...tacomaAccountingCourses, ...tacomaFinanceCourses, ...tacomaMarketingCourses]),
        openEndedRules: [
          ...
          "30 credits of Finance courses chosen from the TFIN and TBECON course offerings",
          "General electives to reach a total of 180 credits",
        ],
      },
    ],
    genEdRequirements: [
      "180 credits required for the baccalaureate degree",
      ...
      "Students must complete all upper-division Business courses with a minimum grade of 1.7",
    ],
    requirementLabels: [
      "Bachelor of Arts in Business Administration",
