...
- [Scoped section: Accounting focuses on recording and reporting financial transactions and students in this option develop the financial a](https://www.tacoma.uw.edu/business/design-courses-baba) - Source used for parser-backed UW requirement extraction.
...
- The Management option prepares you for entry-level management positions and management training programs
...
- TBIOL 331 General Microbiology (6) (formerly TBIOL 301)
- TBIOL 313 Human Physiology (5) (formerly TBIOL 302)
- TBIOL 323 Cellular Biology (6) (formerly TBIOL 303)
- TBIOL 314 Molecular Biology (6) (formerly TBIOL 304)
- TBIOL 325 Genetics and Genomics (6) (formerly TBIOL 305)
- TCHEM 405 Biochemistry 1 (5)
- TCHEM 406 Biochemistry 2 (6)
- Biomedical Electives (15 credits)
...
- Required before enrollment: Civil Engineering students must complete 16 credits of technical electives. Click the button below to view the current a. note: Parsed from a source section heading and the following course rows.
...
- Required before enrollment: Complete 25 credits of 300 and 400 level Computer Science and Systems senior electives (10 credits must be 400-level). note: Parsed from a source section heading and the following course rows.
...
- Required before enrollment: TCSS 101 / TCSS 141. complete at least 1 course from this set
- Required before enrollment: Introduction to Programming and Object-oriented programming. complete at least 1 course from this set
- Required before enrollment: TCSS 101 OR TCSS 141. complete at least 1 course from this set
- Required before enrollment: 15 credits of Object-Oriented Programming. complete at least 1 course from this set
- Required before enrollment: TCSS 142 / TCSS 143. complete at least 1 course from this set
- Required before enrollment: 15 credits of Calculus. complete at least 1 course from this set
- Required before enrollment: No more than 10 credits of TCSS 497, TCSS 498, and TCSS 499 may be used to satisfy the elective requirement.. complete at least 1 course from this set
...
- Required before enrollment: CSE 121 or TCSS 141 -> `CS 121`. complete at least 1 course from this set
- Required before enrollment: MATH 208 / TMATH 208 -> `MATH 240`. complete at least 1 course from this set
- Required before enrollment: Physics III -> `PHYS& 223`. complete at least 1 course from this set
- Required before enrollment: CSE 122 or TCSS 142 -> `CS 122`. complete at least 1 course from this set
- Required before enrollment: T INFO 452 or T INFO 457. complete at least 1 course from this set
- Required before enrollment: T INFO 497 or T INFO 481. complete at least 1 course from this set
- Required before enrollment: TMATH 224 or MATH 224 -> `MATH& 264`. complete at least 1 course from this set
- Required before enrollment: T PHYS 121 or PHYS 121 , T PHYS 122 or PHYS 122, and TPHYS 123 or PHYS 123 -> `PHYS& 221`. complete at least 1 course from this set. alternate path `PHYS& 222` or `PHYS& 223`
- Required before enrollment: T CHEM 142 or CHEM 142 -> `CHEM& 161`. complete at least 1 course from this set
- Required before enrollment: TME 221 or A A 210 -> `ENGR& 214`. complete at least 1 course from this set
- Required before enrollment: TME 222 or CEE 220 -> `ENGR& 225`. complete at least 1 course from this set
- Required before enrollment: TME 223 or M E 230 -> `ENGR& 215`. complete at least 1 course from this set
- Required before enrollment: TCSS 543 or TCSS 540. complete at least 1 course from this set
- Required before enrollment: Thesis or Capstone (10 credits): TCSS 700 or TCSS 702. complete at least 1 course from this set
- Required before enrollment: TINFO 510 or TINFO 520 or TINFO 530 or TINFO 540 or TINFO 550 or TINFO 560 or TINFO 570 or TINFO 580 or TINFO 590. complete at least 4 courses from this set
- Required before enrollment: Thesis/Capstone Project (10 credits): TINFO 700 or TINFO 702. complete at least 1 course from this set
...
- Required before enrollment: TCSS 437 or TCSS 445 or TCSS 450 or TCSS 452 or TCSS 460 or TCSS 461 or TCSS 465 or TCSS 491 or TCSS 498 or TCSS 499. complete at least 1 course from this set
- Required before enrollment: 5 credits from the following approved design electives: TCSS 437, 445, 450, 452, 460, 461, 465, or 491. complete at least 1 course from this set
- Required before enrollment: No more than 10 credits of TCSS 497, TCSS 498, and TCSS 499 may be used to satisfy the elective requirement.. complete at least 1 course from this set
- Required before enrollment: MATH 208 -> `MATH 240`. note: Not part of the minimum transfer-admission classes, but good to complete before or during UW enrollment because it's needed to complete the degree either way.
- Source-backed note: Parser confidence: high.
...
- Required before enrollment: CJ majors must complete 20 credits from the approved core electives list below; each course listed is worth 5 credits un. note: Parsed from a source section heading and the following course rows.
- Required before enrollment: TCRIM 409 or TCRIM 490. complete at least 1 course from this set
- Source-backed note: Parser confidence: high.
...
- TGEOS 241 Oceanography (P, if 6 cr- L)
- TGIS 311 Maps and GIS (P/L) – Urban Studies course
- TMATH 210 Intermediate Statistics with Applications (B/P)
...
- Required:
- TGEOS 337 Environmental Geology (L)
...
- Required before enrollment: Environmental Communication Option (20 credits). complete at least 4 courses from this set
...
- [General History Option](https://www.tacoma.uw.edu/sias/socs/general-history-option)
- [General History Option](https://www.tacoma.uw.edu/sias/socs/general-history-option) - Source used for parser-backed UW requirement extraction.
...
- Required before enrollment: The General History option is designed to offer students a survey of history and build upon the core requirements. In ad. note: Parsed from a source section heading and the following course rows.
- Source-backed note: Parser confidence: high.
- Source-backed note: Parsed degree-map block candidate: uw-tacoma-history:source-degree-map:.
- Source-backed note: Parsed requirement cues extracted from the current official source.
- Source-backed note: Parsed choice statements and pathway notes extracted from the current official source.
...
- Required before enrollment: TINFO 497 Internship or TINFO 481 IT Design Project. complete at least 1 course from this set
- Required before enrollment: MATH 208 -> `MATH 240`. note: Not part of the minimum transfer-admission classes, but good to complete before or during UW enrollment because it's needed to complete the degree either way.
- Source-backed note: Parser confidence: high.
...
- Required before enrollment: The Bachelor of Arts in History requires 60 credits. These will include the required Core Courses (30 credits). The choi. note: Parsed from a source section heading and the following course rows.
...
- Required before enrollment: TMATH 116 / TMATH 120. complete at least 1 course from this set
- Required before enrollment: TECON 480 (5 credits) or TECON 496 (5 credits). complete at least 1 course from this set
...
- Required before enrollment: Developmental psychology (Lifespan or child development; TPSYCH 220, TPSYCH 222, TPSYCH 319 or equivalent). complete at least 1 course from this set
- Required before enrollment: TPSYCH 210 / TPSYCH 212. complete at least 1 course from this set
- Required before enrollment: TPSYCH 260 / TPSYCH 265. complete at least 1 course from this set
- Required before enrollment: One introductory statistics course. complete at least 1 course from this set
- Required before enrollment: *Only 5 credits from TBECON 420, TBECON 421 or TBECON 422 may count towards the minor.. complete at least 1 course from this set
- Required before enrollment: T HIST 200 or T HIST 201. complete at least 1 course from this set
- Required before enrollment: T HIST 150 or T HIST 151. complete at least 1 course from this set
- Source-backed note: Parser confidence: high.
...
- TCSS 321 Discrete Structures I (May open to math majors in Registration Period III. See section details linked in MyPlan.)
...
- Required before enrollment: Mechanical Engineering students must complete 15 credits of electives. Click the button below to view the current academ. note: Parsed from a source section heading and the following course rows.
- Required before enrollment: Multivariable Calculus -> `MATH& 264`. complete at least 1 course from this set
- Required before enrollment: Mechanics of Materials -> `ENGR& 225`. complete at least 1 course from this set
- Required before enrollment: Dynamics - (TME 223 or UWS: ME 230) -> `ENGR& 215`. complete at least 1 course from this set
- Required before enrollment: Electrical Circuits (TCES 215 or UWS: EE 215) is recommended but not required at the time of admission. -> `ENGR& 204`. complete at least 1 course from this set
...
- BASW Admission Requirements and How to Apply
- BASW Requirements Checklist | Tentative TSOCWF Time Schedule | TSOCWF Course Descriptions
