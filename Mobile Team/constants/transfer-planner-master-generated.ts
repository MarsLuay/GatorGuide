export type TransferPlannerMasterCampusId = "uw-seattle" | "uw-bothell" | "uw-tacoma";
export type TransferPlannerMasterChain = {
  id: string;
  type: string;
  rule: string;
};
export type TransferPlannerMasterBank = {
  id: string;
  courses: string[];
};
export type TransferPlannerMasterMajorRow = {
  campusId: TransferPlannerMasterCampusId;
  family: string;
  title: string;
  bankIds: string[];
  chainIds: string[];
...
export const TRANSFER_PLANNER_MASTER_CHAIN_LIBRARY: TransferPlannerMasterChain[] = [
    {
        "id":  "WRIT-SEQ",
        "type":  "GRC sequence",
...
export const TRANSFER_PLANNER_MASTER_BANK_LIBRARY: TransferPlannerMasterBank[] = [
    {
        "id":  "WRIT",
        "courses":  [
                        "ENGL\u0026 101",
...
export const TRANSFER_PLANNER_MASTER_MAJOR_ROWS: TransferPlannerMasterMajorRow[] = [
    {
        "campusId":  "uw-seattle",
