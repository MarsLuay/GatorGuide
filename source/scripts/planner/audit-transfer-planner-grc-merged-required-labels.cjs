...
const OUTPUT_JSON_PATH = getTmpPath(REPO_ROOT, "transfer-planner-grc-merged-required-label-audit.json");
const OUTPUT_MD_PATH = getTmpPath(REPO_ROOT, "transfer-planner-grc-merged-required-label-audit.md");
