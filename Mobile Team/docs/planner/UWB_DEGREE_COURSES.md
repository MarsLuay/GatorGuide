...
- Manual review note: Confirm the student's planned second discipline early, because it materially changes the final degree map and the best Green River transfer strategy.
...
- Manual review note: Community-college microbiology and physiology do not always transfer into the exact Bothell biology core buckets, so confirm those matches before promising a direct slot into Cell Biology or Physiology requirements.
...
- Manual review note: This general BBA row is only a baseline. The final exact course map depends on which business option or concentration the student chooses.
...
- Planner flag: Students cannot start accounting-option courses until they meet with a Bothell adviser to confirm eligibility.
...
- Manual review note: Confirm whether the student wants the full Finance Option or the lighter Finance concentration before treating the exact upper-division list as final.
...
- Manual review note: Confirm whether the student wants the transcripted Marketing Option or the Marketing concentration before treating the exact upper-division path as final.
...
- [UW Bothell Chemistry curriculum](https://www.uwb.edu/stem/undergraduate/majors/chemistry/curriculum) - Auto-promoted from the parsed primary degree page on April 3, 2026.
- [UW Bothell Green River equivalency guide](https://www.uwb.edu/registrar/policies/community-college-course-equivalency-guide/green-river-college)
...
- Manual review note: This row is specifically the Bothell Chemistry B.A. If the student is aiming for the more intensive B.S. general or biochemistry option, use the matching Bothell chemistry rows instead.
...
- Manual review note: Requirement cue lines: B PHYS 121 Mechanics (5 credits) | B PHYS 121 Mechanics (5 credits) | B PHYS 121 Mechanics (5 credits)
- Manual review note: Requirement-mapping consensus: 3/3 exact-title samples for PHYS 123.
- Manual review note: Requirement cue lines: B PHYS 123 Waves (5 credits) | B PHYS 123 Waves (5 credits) | B PHYS 123 Waves (5 credits)
...
- Planner flag: The department strongly recommends planning the physical-chemistry sequence with adviser input because the B.S. chemistry finish is more tightly sequenced than the B.A.
- Manual review note: This row is specifically the Bothell Chemistry B.S. general option, not the separate Biochemistry option.
- Manual review note: Auto-promoted parsed requirement diff on April 3, 2026.
- Manual review note: Source parse confidence: high.
- Manual review note: Requirement-mapping consensus: 3/3 exact-title samples for PHYS 121.
- Manual review note: Requirement cue lines: B PHYS 121 Mechanics (5 credits) | B PHYS 121 Mechanics (5 credits) | B PHYS 121 Mechanics (5 credits)
...
- Manual review note: Validated against the current UW Bothell admissions page, curriculum page, degree map, and active major planning worksheet on April 2, 2026.
- Manual review note: Confirm the worksheet version for the student's intended entry year.
- Manual review note: Upper-division CSS / B EE sequencing should still be checked against the current curriculum page and degree map.
...
- Manual review note: Validated against the current UW Bothell admissions page, curriculum page, degree map, and active major planning worksheet on April 2, 2026.
- Manual review note: The public degree map still leaves some upper-division core details better handled through advising.
...
- Manual review note: Confirm current Bothell versus Seattle/Tacoma cross-campus availability for the IAC option courses before turning the option into a rigid quarter-by-quarter plan.
...
- [UW Bothell Elementary Education degree requirements](https://www.uwb.edu/education/undergraduate/elementary-education/degree-requirements) - Auto-promoted from the parsed primary degree page on April 3, 2026.
- [UW Bothell Green River equivalency guide](https://www.uwb.edu/registrar/policies/community-college-course-equivalency-guide/green-river-college)
...
- Manual review note: Requirement cue lines: CHEM 142 General Chemistry NSc, RSN LAB
- Manual review note: Requirement-mapping consensus: 3/3 exact-title samples for PHYS 121.
- Manual review note: Requirement cue lines: PHYS 121 General Engineering Physics I
...
- [UW Bothell Electrical Engineering curriculum](https://www.uwb.edu/stem/undergraduate/majors/electrical/curriculum) - Auto-promoted from the parsed primary degree page on April 3, 2026.
- [UW Bothell Green River equivalency guide](https://www.uwb.edu/registrar/policies/community-college-course-equivalency-guide/green-river-college)
...
- Manual review note: Source parse confidence: high.
- Manual review note: Requirement-mapping consensus: 4/4 exact-title samples for CHEM 142.
- Manual review note: Requirement cue lines: B CHEM 143+144 General Chemistry I/Lab (6) (or CHEM 142 (5))
- Manual review note: Requirement-mapping consensus: 3/3 exact-title samples for PHYS 121.
- Manual review note: Requirement cue lines: * B PHYS 121 Mechanics (5)
- Manual review note: Requirement-mapping consensus: 3/3 exact-title samples for PHYS 123.
- Manual review note: Requirement cue lines: B PHYS 123 Waves (5)
...
- Manual review note: The current public materials describe the curriculum cleanly, but the exact elective mix still depends on the student's intended health pathway and the annually approved elective lists.
...
- Planner flag: Any current student still finishing IMD should rely on adviser-approved archived materials rather than assuming the old public plan still runs unchanged.
- Manual review note: This is an archival row only. Because IMD no longer accepts new applicants, any current student still finishing the degree should use adviser-approved archived materials rather than assume the old public plan still runs unchanged.
...
- Manual review note: This is intentionally a proposal-based degree. The exact UW course list must stay faculty-approved rather than being treated like a frozen universal checklist.
...
- Planner flag: Any current student still finishing MTV should rely on adviser-approved legacy guidance rather than assuming the old public plan still runs unchanged.
- Manual review note: Treat this as a legacy row for continuing students. New students should not be planned into MTV as if it were still the active admission path.
...
- [UW Bothell Mechanical Engineering curriculum PDF](https://www.uwb.edu/stem/wp-content/uploads/sites/31/2025/01/B-ME-Curriculum-AY24_25.pdf) - Auto-promoted from the parsed primary degree page on April 3, 2026.
...
- Manual review note: This row is a specialized first-year partner pathway, not a normal community-college transfer finish. Use School of Nursing advising before treating it like a standard Green River transfer target.
...
- Manual review note: This is a degree-completion path for already licensed or pending-licensure nurses after ADN preparation, so it is not a normal direct Green River pre-major finish.
...
- Planner flag: Because SEHB is a legacy category-based finish, the final course mix should stay aligned with adviser-approved completion guidance.
- Manual review note: SEHB is a legacy completion row only. New applicants should not be planned into it as if it were still an actively admitting major.
